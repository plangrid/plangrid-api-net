...
namespace PlanGrid.Api
{
    ...
    {
        public static async Task<T> Resolve<T>(this IPlanGridApi api, RecordReference<T> reference) where T : Record
        {
        ...
        public static async Task<T> Post<T>(this IPlanGridApi api, string url, object request)
        {
            ...
            var client = new HttpClient(new PlanGridHttpHandler(generatedApi.ApiKey, generatedApi.Settings, generatedApi.Version));
        ...
        public static async Task<T> Get<T>(this IPlanGridApi api, string url)
        {
            var generatedApi = (AutoGeneratedIPlanGridApi)api;
            JsonSerializerSettings settings = generatedApi.Settings.JsonSerializerSettings;
